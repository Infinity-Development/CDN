    ...
    return (
        <div className="container">
            ...
            <div className="sub-container">
                <img src="/images/png/BotError.gif" style={{ width: '125px', height: '125px'}}/>
                <h1 style={{color: '#7289DA'}}>404 - Not Found</h1>
                <hr />
                <h3>
                  Whoa it seems you're lost in our cyberspace, Maybe you should return back to sanity chief!
                  <br /><br />
                  If you know what you're looking for here. Please provide a valid image/file link or endpoint
                </h3>
                <hr />
                <a href="https://infinitybots.gg"><button className="viewbutton">Go Home</button></a>
                <a href="https://infinitybots.gg/discord"><button className="viewbutton">Contact Us</button></a>
            </div>
